...
require_once 'admin/showblog.php';
require_once 'admin/showTest.php';
require_once 'admin/show_members.php';
...
$profile=$_POST["type"];
        ...
        //Deal with the email
        $to = 'contact@thecreativekey.com.test-google-a.com';
        $subject = 'Careers';
...
--_1_$boundary--";
       ...
       if(mail($to, $subject, $message, $headers))
       {
         ...
         echo 'alert("Thank you for your application. We will get back to you shortly.")';
         echo '</script>';
 }
else
{
         echo '<script language="javascript">';
         echo 'alert("Error Sending  Mail Please Try Again")';
         echo '</script>';
}
...
if (isset($_POST['SubmitBtn2'])) {
 ...
 echo '<script language="javascript">';
         echo 'alert("Thank you for contacting us. We will answer your query shortly.")';
         echo '</script>';
    ...
    <body >
        ...
        <header id="navigation" class="navbar-fixed-top navbar ">
                <div class="navbar-header">
					...
					<!-- /logo -->
                    <a class="navbar-brand" href="Ristorante Con Fusion.html" style="padding-left: 30px;"><small>Yash Mittra</small></a>
                </div>
      ...
      <source src="Comp 1_1.mp4" type="video/mp4" style="transition: none; line-height: 9px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 5px;">
      <source src="Comp 1_1.mp4" type="video/ogg" style="transition: none; line-height: 9px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 5px;">
      <source src="Comp 1_1.mp4" type="video/webm" style="transition: none; line-height: 9px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 5px;">
      </video>
      </div>
...
<img src="image/banner.png">
    ...
    <div class="container-fluid" id="services" style="background:url('image/service6.png');height:800px;padding-left:0px background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;">
          	...
          	<div class="col-md-7 col-md-offset-5 details">		
               <div class="wow fadeInUp col-md-6 pb20 mb10 ">
                ...
                <div class="col-md-9">
               	<h4 class="pb10" style="color: #222222;font-weight:600;">CONTENT</h4>
                <p style="font-weight:500;">From a three worded tagline to a colossal website, if your task involves the use of words, we know how to cast an influence just right.</p>
               </div> 
               </div>
               <div class="wow fadeInUp col-md-6 pb20 mb10 ">
                <div class="col-md-3" style="float:left"><img src="image/design.png"></div>
                <div class="col-md-9">
               	<h4 class="pb10" style="color: #222222;font-weight:600;">DESIGN</h4>
                <p style="font-weight:500;">The fundamentals of design guide our hands. Even your tiniest graphic need is reciprocated with creativity and an absolute perfection.</p>.
               </div> 
               </div>
                ...
                <div class="col-md-9">
               	<h4 class="pb10" style="color: #222222;font-weight:600;">SOCIAL MEDIA MARKETING</h4>
                <p style="font-weight:500;">To amplify your business, is our business. With innovative social media strategies, we don’t just build your potential customers, but advocates for your brand.</p>
               </div> 
               </div>
                <div class="wow fadeInUp col-md-6 pb20 pt20 mt10 mb10 " data-wow-delay="1000ms">
                <div class="col-md-3" style="float:left"><img src="image/events.png"></div>
                <div class="col-md-9">
               	<h4 class="pb10" style="color: #222222;font-weight:600;">EVENTS</h4>
                <p style="font-weight:500;">Being the smart commuicators we are, we have mastered to make a small events a part of your lifetime memories. Be it a corporate meet up or a pop-up stall, we plan your 'big day' with utmost customizations and precision.</p>
               </div> 
               </div>
			</div>		
        </div>
...
<script type="text/javascript">
    ...
    background-size: cover !important;">
        ...
        <div class="container pb50 pt50">
        	<div class="row wow fadeInUp ">
                  ...
                  <p>Oh, and we blog sometimes. Stay updated with the latest trends in the digital space, what the team is up to and a lot of witty-humorous content.</p>
                    	...
                    	<div class="update">
                            ...
                            <div class="pt30 pb30 pr30 pl30" style="background-color:#fff;font-size:12px;">
                                ...
                                <div class="update-head mb20"><a><?php echo $row['postitle']; ?></a></div>
                                <div class="update-data" style="height:90px;overflow:hidden"><?php echo $row['postdesc']; ?></div>
                                <div class="update-data pull-right" ><p><a style="margin-bottom:20px" href="<?php echo $row['postcontent']; ?>" style="color:#3276b1">Read More...</a></p></div>
                            </div>
                        </div>
        			</div>
              ...
              <div class="blog text-center">
                    <a href="http://thecreativekey.com/wordpressblog/" class="btn" style="">MORE</a>
                    </div>
        	</div>
        </div>
        </div>
        
        <div style="background-image:url('image/p1.jpg');height:800px;" id="testimonial">
         <div style="">
        	<div class="container people-say" style>
            	<div class="row">
                	<div class="col-md-6 people wow fadeInUp" style="height:800px;">
                    	<h4 class="pt30 mb20"><strong>WHAT</strong> PEOPLE SAY</h4>
                        <div>
                        <p style="color:#fff">Hear it out from our clients.</p>
                        </div>
                    </div>
          ...
          <?php $item_class = ($i == 1) ? 'item active' : 'item'; ?>
            ...
            <div class="<?php echo $item_class; ?>" >
             ...
             <p style="overflow-y:scroll;"><?php echo $res['postcontent'] ?></p>
			 </blockquote>
             <img width="80" height="80" style="border-radius:100%" src="<?php echo "http://thecreativekey.com/admin-creativekey/".$res['image_path'] ?>" class="avatar wp-post-image col-xs-3 img-responsive" alt="02" style="border-radius:100%;">
        ...
        <div style="background-color: #f7f7f7 !important;height:800px;">
...
<script>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control numeric" maxlength="10" id="contact" name="contact"><span class="error" style="color: Red; display: none">* Input digits (0 - 9)</span>
  </div>   
   <div class="col-lg-6 col-sm-6 col-12">
                ...
                <div class="input-group">
                    <span class="input-group-btn">
	                    <span class="btn btn-primary btn-file">
	                        Browse&hellip; <input type="file" name="fileupload1" accept=".jpeg,.docx,.pdf">
	                    </span>
                    </span>
        ...
        <div class="modal-footer">
         ...
         <input type="submit" class="btn btn-info" name="SubmitBtn" value="submit" >
        </div>
      </div>
        </form>
    </div>
        ...
        <div class="container hidden-sm hidden-xs" id="team">
			...
			<?php foreach($mem as $m ) { ?>
					<div class="col-md-3 mb20 team-member">
                    	<img src="<?php echo 'http://thecreativekey.com/admin/images/'.$m['image'] ?>" class="img-responsive" >
        ...
        <div class="container hidden-lg hidden-md" id="team">
        	<div class="row team wow fadeInUp">
            	<h1 class="text-center pb20">OUR TEAM</h1>
                
               
                	<ul id="carousel1" class="elastislide-list col-md-2">		
					
			<?php foreach($mem as $m ) { ?>
					<li><div class="col-md-3 mb20 team-member">
                    	<img src="<?php echo 'http://thecreativekey.com/admin/images/'.$m['image'] ?>" class="img-responsive" >
                        <div class="team-data col-xs-10 col-xs-offset-1 mb20" style="padding-left:0px;padding-right:0px;">
        ...
        <div class="follow"  id="contactus" style="background:url(image/home10.png)">
        	<div class="container">
            	<div class="row">
                	<div class="col-md-4">
                    	...
                    	<div class="follow-social mt40" style="padding-left:0px;">
                    		<div class="col-md-6" style="padding-left:0px;">
                       	    ...
                       	    <div class="col-md-6" style="padding-left:0px;">
                            	...
                            	<a href="https://www.linkedin.com/company/13244846?trk=tyah&trkInfo=clickedVertical%3Acompany%2CclickedEntityId%3A13244846%2Cidx%3A2-1-2%2CtarId%3A1486712538797%2Ctas%3Athe%20creative%20key" target="_blank" style="color:#fff"><div class="mb30" style="font-size: 15px;color: #ffffff;line-height: 1;text-align: left;font-weight: 700;text-transform: uppercase;letter-spacing: 0.12em"><i class="fa fa-linkedin"></i> Linkedin</div></a>
                            </div>
                   	    </div>
               	    </div>
        ...
        $(function () {
            ...
            $(".numeric").bind("drop", function (e) {
                return false;
                    ...
                    <div class="col-md-7 col-md-offset-1" style="height:800px;">
                    	<div class="form-head mb30">DROP A LINE</div>
                          <form action="index.php" role="form" method="post"  name="name1" class="form-area" onSubmit="return ValidateData()"  enctype='multipart/form-data'>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                <input type="phone" class=" form-control input-lg input-area numeric" maxlength="10" name="contact_no" id="phone_no" placeholder="Contact No.">
<span class="error" style="color: Red; display: none">* Input digits (0 - 9)</span>
       ...
       <div class="container pt30 pb30" style="padding-bottom:100px;">
        ...
        <div class="footer-wrapper">
				...
				<div class="container">
					...
					<div class="office">
					<p style="font-size:13px;font-weight:100;">133,Top floor, Lane No. 1,</p><p style="font-size:13px;font-weight:100;">Westend Marg, Saidulajab, Saket</p>
					<p style="font-size:13px;font-weight:100;">New Delhi-110030</p>
					<p></p>
                        ...
                        <a href="https://twitter.com/the_creativekey" target="_blank" style="color:#fff"><div class="mb30 col-xs-1" style="font-size: 18px;color: #ffffff;line-height: 1;text-align: left;font-weight: 700;padding-left:0px;text-transform: uppercase;letter-spacing: 0.12em"><i class="fa fa-twitter"></i></div></a>
                            	<a href="https://www.linkedin.com/company/13244846?trk=tyah&trkInfo=clickedVertical%3Acompany%2CclickedEntityId%3A13244846%2Cidx%3A2-1-2%2CtarId%3A1486712538797%2Ctas%3Athe%20creative%20key" target="_blank" style="color:#fff"><div class="mb30 col-xs-1" style="font-size: 18px;color: #ffffff;line-height: 1;text-align: left;font-weight: 700;padding-left:0px;text-transform: uppercase;letter-spacing: 0.12em"><i class="fa fa-linkedin"></i></div></a></div>
...
<li><a href="#career" style="color:#fff;"><div class="mt20" style="font-size: 12px;color: #ffffff;line-height: 1;text-align: left;font-weight: 200;text-transform: uppercase;letter-spacing: 0.12em">Careers</div></a></li>
<li><a href="#blog" style="color:#fff;"><div class="mt20" style="font-size: 12px;color: #ffffff;line-height: 1;text-align: left;font-weight: 200;text-transform: uppercase;letter-spacing: 0.12em">Blogs</div></a></li>
							</ul>
                        </div>
                        </aside>	
                    	</div>
